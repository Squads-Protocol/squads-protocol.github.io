            ...
            <ol>
                ...
                <li>
                    ...
                    <ol type="a">
                        ...
                        <li>If a potential Dispute arises, you must contact us by sending an email to <a href="mailto:info@sqds.io" class="email">info@sqds.io</a> so that we can attempt to resolve it without resorting to formal dispute resolution.</li>
                ...
                <li>
                    ...
                    <ol type="a">
                        ...
                        <li>Right to Opt-out. You have the right to opt-out and not be bound by the arbitration and class action waiver provisions set forth above by sending written notice of your decision to opt-out via email to <a href="mailto:info@sqds.io" class="email">info@sqds.io</a>. The notice must be sent within 30 days of your first use of our Services, otherwise you shall be bound to arbitrate disputes in accordance with the terms of those paragraphs. If you opt-out of these arbitration provisions, we also will not be bound by them.</li>
